        ...
        <div class="card-body">
            <form class="form-sample" action="{{ $module->permalink.'/save' }}" id="form-table" method="post"
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('certificate') error-input @enderror text-capitalize"
                                    ...
                                    <option value="v1" @if( old('certificate') && old('certificate') !=="" &&
                                        old('certificate')==='v1' ) selected @endif>yes</option>
                                    <option value="v0" @if( old('certificate') && old('certificate') !=="" &&
                                        old('certificate')==='v0' ) selected @endif>no</option>
                                </select>
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('status') error-input @enderror text-capitalize"
                                    ...
                                    <option value="{{$val}}" @if( old('status') && old('status') !=="" &&
                                        old('status')===$val ) selected @endif>{{$val}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="price"
                                    ...
                                    value="{{old('price')}}"
                                    placeholder="Rp 0.00" @if(old('type') !== "premium") disabled @endif>
                            ...
                            <div class="col-sm-9">
                                <select class="form-control @error('level') error-input @enderror text-capitalize"
                                    ...
                                    <option value="{{$val}}" @if( old('level') && old('level') !=="" &&
                                        old('level')===$val ) selected @endif>{{$val}}</option>
                                    @endforeach
                                </select>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="some-textarea form-control" rows="10">{{old('description') ?: ''}} </textarea>
...
$(document).ready(function() {
    ...
    $('.dropdown').each(function(index, dropdown) {
        ...
        @if(old('mentor_id'))
        @php
        $_mentor = detail_mentors(session('user_token'), old('mentor_id'));
