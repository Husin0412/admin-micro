                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <img src="{{$data_edit['avatar'] ?: url('assets/images/null.png')}}" alt="" class="col-sm-2 rounded-circle" height="80">
                            <div class="col-sm-7">
                            <input type="hidden" name="avatar-existing" value="{{$data_edit['avatar'] ?: 'hei'}}">
                            <input type="file" class="py-4" name="avatar" accept="image/x-png,image/jpeg,image/jpg">
